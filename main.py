...
def newUser():
    ...
    btn1=Button(signUp,text='Sign Up',fg='black',bg='yellow',font=('Arial',11,'bold'),activebackground='black',activeforeground='yellow',command=login,cursor='hand2')
...
def createWindow():
    ...
    def fun_1(*args):
        ...
        print(entry1.get())
        # cities.remove(entry1.get())

    def fun_2(*args):
        entry2.insert(10,variable1.get())
        print(entry2.get())
        # cities.remove(entry2.get())

    def fun_3(*args):
        entry3.insert(10,variable2.get())

    cities = ['Kolkata', 'Ajmer','Mumbai','Hyderabad','New Delhi','Gujarat','Chandigarh','Chennai']
    ...
    def Check1():
        if (entry1.get() == "Ajmer" and entry2.get() == "Chandigarh" and entry3.get() == "3A") or (entry1.get() == "Ajmer" and entry2.get() == "New Delhi" and entry3.get() == "3A"):
            ...
            #     else:
            #         tkinter.messagebox.showinfo('Error', 'Enter day Correctly!')
            # else:
    ...
    def Search():
            ...
            def PassengerDetails():
                ...
                for i in range(height):  # Rows
                    for j in range(width):  # Columns
                        ...
                        e6 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        enn7 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        enn8 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        enn9 = Entry(window2, justify="center", font=('Slab Serif', 3))
                        e10 = Entry(window2, justify="center", font=('Slab Serif', 3))
                        e11 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e12 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e13 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e14 = Entry(window2, justify="center", font=('Slab Serif', 3))
                        e15 = Entry(window2, justify="center", font=('Slab Serif', 3))
                        e16 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e17 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e18 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e19 = Entry(window2, justify="center", font=('Slab Serif', 3))
                        e20 = Entry(window2, justify="center", font=('Slab Serif', 3))
                        e21 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e22 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        e23 = Entry(window2, justify="center", font=('Slab Serif', 9), bg="#218380")
                        ...
                        popupMenu1.config(font=('Slab Serif', 9), bg='#0B1D51', fg='white')
                        ...
                        popupMenu2.config(font=('Slab Serif', 9), bg='#0B1D51', fg='white')
                        ...
                        popupMenu3.config(font=('Slab Serif', 9), bg='#0B1D51', fg='white')
                        ...
                        popupMenu4.config(font=('Slab Serif', 9), bg='#0B1D51', fg='white')
                ...
                def process_payment():         
                    ...
                    x = (screen_width/2) - (width/2)
                    y = (screen_height/2) - (height/2)
                    root.geometry('%dx%d+%d+%d' % (width, height, x-450, y))
                    root.resizable(0, 0)
                    ...
                    # Define the widgets
                    Label(root, text="Would you like to proceed?",font=('Slab Serif',17),bg='#6cadd4',fg="yellow").place(x=0,y=120,width=400)
                    Label(root, text="Your ticket Price is ₹1 ",font=('Slab Serif',17),bg='#509ccc',fg="yellow").place(x=0,y=170,width=400)
                    Button(root, text="Pay ",font=('Slab Serif',15),bg='blue',fg='white', command=pay).place(x=150,y=290,width=100)
                    # Start the mainloop
                    root.mainloop()        
                ...
                b = Button(window2, text='Payment', bg="cyan", font=('Slab Serif', 11), command=process_payment)
        ...
        def PassengerDetails2():
            ...
            def PassengerDetails():
                ...
                def process_payment():
                    ...
                    root.mainloop()        
                   # while True:
                    #    event = root.wait_window(root)
                     #   if event == "success":
                      #      tk.messagebox.showinfo("Payment Successful", "Your payment was successful!")
                       #     Check1()
                        #    break
                        #elif event == "error":
                        #    tk.messagebox.showerror("Payment Failed", "Your payment failed. Please try again.")
                         #   break                              
        ...
        button1=Button(window1,text="Book",font=('Slab Serif',9),width=10,bg="#218380",command=PassengerDetails1)
        button1.grid(row=1,column=7)
        button2 = Button(window1, text="Book",font=('Slab Serif',9),width=10, bg="#218380",command=PassengerDetails2)
        button2.grid(row=2, column=7)
        button3 = Button(window1, text="Book",font=('Slab Serif',9),width=10, bg="#218380", command=PassengerDetails3)
        button3.grid(row=3, column=7)
        button4 = Button(window1, text="Book",font=('Slab Serif',9),width=10,bg="#218380", command=PassengerDetails4)
